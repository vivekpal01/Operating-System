...
#icon
image_icon=PhotoImage(file="Image/tools1.png")
...
lbl_brightness=Label(RHS,text='Brightnesss',font=('arial',10,'bold'),bg="#f4f5f5")
...
def game():
    app5=Toplevel()
    app5.geometry("400x600+1270+270")
    app5.title("ludo")
...
app9_image=PhotoImage(file='Image/youtube.png')
