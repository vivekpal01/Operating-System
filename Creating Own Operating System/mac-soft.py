...
#icon
image_icon=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/icon.png")
...
#-----------------------------------
LHS=Frame(Body,width=310,height=435,bg="#f4f5f5", highlightbackground="#adacb1",highlightthicknes=1)
LHS.place(x=10,y=10)

#logo
photo=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/laptop.png")
...
l2=Label(LHS,text=f"Veraion:{my_system.version}",bg="#f4f5f5",font=("Acumin Variable Concept",8),justify="center")
l2.place(x=20,y=225)
...
#########################################
RHS=Frame(Body,width=470,height=230,bg="#f4f5f5", highlightbackground="#adacb1",highlightthicknes=1)
...
def none():
    ...
    if battery.power_plugged==True:
        battery_png=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/charging.png")
        battery_label.config(image=battery_png)
         
    else:
        battery_png=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/battery.png")
        battery_label.config(image=battery_png)



    
lbl=Label(RHS,font=("Acumin Variable Concept",20,'bold'),bg='#f4f5f5')
...
def volume_changed(event):
    ...
    playsound('C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/ping.mp3')
    volume = cast(interface, POINTER(IAudioEndpointVolume))
    volume.SetMasterVolumeLevel(-float(get_current_volume_value()),None)

style= ttk.Style()
style.configure("TScale", background='#f4f5r5')
...
lbl_brightness=Label(RHS,text='Brightnesss',font=('arial',7,'bold'),bg="#f4f5f5")
...
def weather():
    ...
    #icon
    image_icon=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App1.png')
    ...
    def getWeather():
        ...
        #weather
            api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=45d06bb74f442c965d9a27bd09923df3"
    ...
    #search box
    Search_image=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/search.png")
    ...
    Search_icon=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/search_icon.png")
    myimage_icon=Button(app1,image=Search_icon,borderwidth=0,cursor="hand2",bg="#404040",command=getWeather)
    myimage_icon.place(x=400,y=34)

    #logo
    Logo_image=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/logo.png")
    logo=Label(app1,image=Logo_image,bg="#f4f5f5")
    logo.place(x=150,y=100)


    #bottom box
    Frame_image=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/box.png")
    ...
    t=Label(app1,font=('arial',40,'bold'),fg="#ee666d",bg='#f4f5f5')
    t.place(x=400,y=150)
    ...
    h.place(x=280,y=430)
    d=Label(app1,text="...",font=('arial',13,'bold'),bg="#1ab5ef")
    d.place(x=450,y=430)
...
def clock():
    ...
    #icon
    image_icon=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App2.png")
...
def calendar():
    ...
    #icon
    image_icon=PhotoImage(file="C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App3.png")
...
def workflow():
    ...
    openfile.pack(side=tk.LEFT, ipadx=80, padx=5, pady=3)

    runApps = tk.Button(root, text='Run Files', padx = 10, pady = 5, fg = 'white', bg = '#263D42', command=runApps)
    runApps.pack(side=tk.RIGHT, ipadx=80, padx=5, pady=3)
...
app1_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App1.png')
app1=Button(RHB,image=app1_image,bd=0,command=weather)
app1.place(x=15,y=50)


app2_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App2.png')
app2=Button(RHB,image=app2_image,bd=0,command=clock)
app2.place(x=100,y=50)


app3_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App3.png')
app3=Button(RHB,image=app3_image,bd=0,command=calendar)
app3.place(x=185,y=50)

app4_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App4.png')
app4=Button(RHB,image=app4_image,bd=0,command=mode)
app4.place(x=270,y=50)

app5_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/workflow1.png')
app5=Button(RHB,image=app5_image,bd=0,command=workflow)
app5.place(x=355,y=50)

app6_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App6.png')
app6=Button(RHB,image=app6_image,bd=0,command=screenshot)
app6.place(x=15,y=120)

app7_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App7.png')
app7=Button(RHB, image=app7_image,bd=0,command=file) 
app7.place(x=100,y=120)

app8_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App8.png')
app8=Button(RHB,image=app8_image,bd=0,command=crome)
app8.place(x=185,y=120)

app9_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App9.png')
app9=Button(RHB,image=app9_image,bd=0, command=close_apps)
app9.place(x=270,y=120)

app10_image=PhotoImage(file='C:/Users/vivek pal/Desktop/Seminar PPT/Creating Own Operating System/App10.png')
